...
- Ensure `server_name_indication` is always a charlist to prevent session cache misses in `:ssl`
- Log SSL connection information in debug mode to help diagnosing connection issues
